    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="bg-white rounded-2xl max-w-md w-full p-6 sm:p-8 shadow-xl">
        ...
        <p className="text-sm text-[#14120b]/70 mb-4">
          Budget mode estimates what a monthly spend ceiling gets you. Usage mode estimates total usage cost and out-of-pocket spend after plan coverage. Cloud, Bugbot, and automations have their own cost view.
        </p>
