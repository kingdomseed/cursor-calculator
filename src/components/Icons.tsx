...
export function JHDIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 258 258" fill="none">
      ...
      <path d="m39.4 163v-20.5h7.05c5.25 0 9.4-1.48 12.46-4.43 3.17-3.06 4.76-7.11 4.76-12.14v-85.12h22.47v84.3c0 7.54-1.64 14.16-4.92 19.84-3.17 5.69-7.76 10.11-13.78 13.28-5.9 3.17-12.9 4.76-20.99 4.76z" fill="#333" />
      <path d="m106.81 163v-122.18h22.3v53.3h51.99v-53.3h22.47v122.18h-22.47v-49.2h-51.99v49.2z" fill="#333" />
    </svg>
  );
}
