...
export function ModeToggle({ mode, onChange }: { mode: Mode; onChange: (m: Mode) => void }) {
  return (
    <div className="text-center">
      ...
      <p className="mx-auto mt-3 max-w-xl text-xs text-[#14120b]/50">
        Budget mode starts with your monthly spend ceiling. Usage mode starts with the tokens you expect to use.
      </p>
    </div>
  );
}
